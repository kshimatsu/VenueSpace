class VenuesController < ApplicationController
  ...
  private
    ...
    def venue_params
      params.require(:venue).permit(:name, :phone_number, :address, :city, :state, :zip, :email, :website, :facebook, :twitter, :instagram, :space, :capacity, :available_parking, :changing_rooms, :restrooms, :electric_outlets, :indoors, :outdoors, :handicap, :coordinator, :budget, :picture, :faqs)
    end
end
